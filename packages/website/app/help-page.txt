<template>
	<main id="help">
		...
		<ul>
			...
			<li>
				displayed max mana is off by 1? ryze 16.9.1 test. Doesn't seem to be round/ceil issue, maybe Ryze's passive is wrong? TODO when ryze's passive has more test cases
			</li>
		</ul>
		...
		<p>non-passive abilities (like <a>Ambessa R passive</a> or <a>Nocturne W passive</a>) and rune paths <strong>are not considered</strong> <i>(yet)</i> in the calculations. See the <a>champion/item/rune setup</a> recommended for verifying the calculations yourself</p>
