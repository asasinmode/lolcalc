...
export const CHAMPION_COMPONENTS: Partial<Record<IChampionId, ISpecificComponents>> = {
	...
	Nasus: {
		extras: await progressExtra(GameAbilityId.build(AbilityType.champion, 'Nasus', 'w', 0), 'wProgress', 'applied Wither slow on target', CHAMPION_SPECIFICS.Nasus.WITHER_MS_SLOW),
	},
	Nidalee: {
