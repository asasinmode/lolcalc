...
export const CHAMPION_COMPONENTS: Partial<Record<IChampionId, ISpecificComponents>> = {
	...
	Nami: {
		extras: await progressExtra(GameAbilityId.build(AbilityType.champion, 'Nami', 'passive', 0), 'passiveMSProgress', 'Surging Tides move speed', CHAMPION_SPECIFICS.Nami.PASSIVE_BONUS_MS, ''),
	},
	Nasus: {
